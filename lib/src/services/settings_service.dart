...
class SettingsService extends ADataSource {
  ...
  Future<Null> cacheAuthKey(String text) async {
    await wrapTransaction(settingsStore, ADataSource.idbSettingsStore,
        ADataSource.readWritePermission, (idb.ObjectStore store) async {
  ...
  Future<Option<String>> getCachedAuthKey() async {
    return await wrapTransaction(settingsStore, ADataSource.idbSettingsStore,
        ADataSource.readOnlyPermission, (idb.ObjectStore store) async {
